...
export class CategoryResponseDto {
    ...
    @ApiProperty({ description: 'Category description', example: 'Mobile gadgets', required: false })
    description?: string;

    @ApiProperty({ description: 'Image URL', example: 'https://example.com/image.png', required: false })
    image_url?: string;

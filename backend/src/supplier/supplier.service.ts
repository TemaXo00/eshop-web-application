...
export class SupplierService {
    ...
    async createSupplier(dto: CreateSupplierDto, userId: number) {
        ...
        if (existName) throw new ConflictException('Supplier with name already exists');
        if (existPhone) throw new ConflictException('Supplier with phone already exists');
        if (existEmail) throw new ConflictException('Supplier with email already exists');
